...
namespace IcarusLoginServer.Network.Protocols
{
    internal class LoginProtocol : IScsWireProtocol
    {
        protected MemoryStream Stream = new MemoryStream();

        public byte[] GetBytes(IScsMessage message)
        {
            return ((LoginMessage) message).Data;
        }
    ...
    internal class LoginMessage : ScsMessage
    {
