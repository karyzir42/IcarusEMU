...
namespace IcarusLobbyServer.Network.Protocols
{
    internal class WireLobbyProtocol : IScsWireProtocol
    {
        protected MemoryStream Stream = new MemoryStream();

        public byte[] GetBytes(IScsMessage message)
        {
            return ((LobbyMessage) message).Data;
        }
    ...
    internal class LobbyMessage : ScsMessage
    {
